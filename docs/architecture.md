...
Decisions made during implementation (ADR-13 to ADR-16: Docker Engine in WSL2, pinned tool versions, Helm 4, and the temporary Kubernetes 1.34 pin caused by cgroup v1) are recorded in [adr/README.md](adr/README.md).
